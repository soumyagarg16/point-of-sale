...
let inventoryReportDataTable = $('#inventory-report-table').DataTable({
            scrollY: '45vh',
...
function displayReport(data){
    ...
    inventoryReportDataTable.destroy();
    $tbody.empty();
    let count = 1;
    for(var i in data){
        var entry = data[i];
    ...
    inventoryReportDataTable = $('#inventory-report-table').DataTable({
                scrollY: '45vh',
                scrollCollapse: false,
                paging: false,
                searching: false,
...
function init(){
    $('#generate-inventory-report').click(getReport);
    getAll();
